...
def send_answer_to_stepik(lesson_url, first_webdriver, again=False):
    answer = float(
        first_webdriver.switch_to.alert.text.rsplit(maxsplit=1)[-1]
    )
...
def solve_quiz_and_get_code(webdriver):
